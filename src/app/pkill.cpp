...
// ---------------------------------------------------------------------------
// pkill_json (persistence codec) relocated to pkill_json.cpp (persist-split PS Task 2).
 ...
 */
int pkill_weight(struct char_data* victim, const rots::combat::kill_contributor_list& contributors)
{
    int total_levels;

    /*
     * TASK-026: the contributor list replaces this walk's own
...
int pkill_opponents(struct char_data* victim, const rots::combat::kill_contributor_list& contributors)
{
    int total_opponents;
...
void pkill_create(struct char_data* victim, const rots::combat::kill_contributor_list& contributors)
{
    int weight;
    int opponents;
    int start;
