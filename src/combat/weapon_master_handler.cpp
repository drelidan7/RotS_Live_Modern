...
weapon_master_handler::weapon_master_handler(char_data* in_character, const obj_data* in_weapon)
    : character(in_character)
    , weapon(in_weapon)
    , spec(utils::get_specialization(*in_character))
{
...
int weapon_master_handler::append_score_message(char* message_buffer) const
{
    ...
    case game_types::WT_BLUDGEONING_TWO:
        strcpy(message_buffer, "Your mastery grants offensive prowess and staggering blows.\r\n");
        return static_cast<int>(strlen(message_buffer));
    case game_types::WT_CLEAVING:
    case game_types::WT_CLEAVING_TWO:
        strcpy(message_buffer, "Your mastery grants unrivaled power to your blows.\r\n");
        return static_cast<int>(strlen(message_buffer));
    case game_types::WT_FLAILING:
        strcpy(message_buffer, "Your mastery grants power to your blows and renders shields ineffective.\r\n");
        return static_cast<int>(strlen(message_buffer));
    case game_types::WT_PIERCING:
        strcpy(message_buffer, "Your mastery grants swiftness to your blows and renders armor useless.\r\n");
        return static_cast<int>(strlen(message_buffer));
    case game_types::WT_SLASHING:
    case game_types::WT_SLASHING_TWO:
        strcpy(message_buffer, "Your mastery grants balanced prowess and occasional swift strikes.\r\n");
        return static_cast<int>(strlen(message_buffer));
    case game_types::WT_SMITING:
        strcpy(message_buffer, "Your mastery grants offensive prowess and dazing blows.\r\n");
        return static_cast<int>(strlen(message_buffer));
    case game_types::WT_STABBING:
        strcpy(message_buffer, "Your mastery grants defensive prowess and armor piercing blows.\r\n");
        return static_cast<int>(strlen(message_buffer));
