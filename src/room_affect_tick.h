...
//
// This header is deliberately flat/top-level rather than
// src/combat/include/...: its one caller is affect_update_room() in
// src/combat/limits.cpp, and the tests include it the same way they include
// handler.h/spells.h.
